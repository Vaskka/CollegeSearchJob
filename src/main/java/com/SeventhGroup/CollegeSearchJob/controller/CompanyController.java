...
public class CompanyController {
    ...
    public Map<String, Object> login(@PathVariable(value="companyEmail") String companyEmail,
        ...
        @ResponseBody
        @RequestMapping(value ="company/changePassword/{companyId}/{companyEmail}/{comPassword}",method = RequestMethod.GET)
        public Map<String, Object> changePassword(@PathVariable(value="companyId") String companyId,
            ...
            companyService.changePassword(companyId, companyEmail, comPassword);
            map.put("msg", "success");
            return map;
        }
    }
